...
\vspace{0.6cm}
\begin{center}
  \begin{tiny}(We have \pageref{LastPage} slides. Make yourselves comfortable.)\end{tiny}
\end{center}
...
\includegraphics[height=30mm,width=30mm]{troll.png}
...
\pause
\includegraphics[height=30mm,width=30mm]{notbad.png}
...
\includegraphics[height=30mm,width=30mm]{cereal.png}
...
\includegraphics[height=30mm,width=30mm]{spitting.png}
...
\begin{itemize}
  \item widgets \pause
  \item \texttt{stdlib} replacement \pause
  \item modern C++ (signals, introspection) \pause
  \item threading/concurrency \pause
  \item networking, XML support, OAuth library \pause
  \item kitchen sink
\end{itemize}

}

\frame{\frametitle{Visigoth \ding{170} Qt}
