...
networks share low average path lengths, high clustering coefficients and
...
comprising of a set of \emph{nodes} $N$ and a set of \emph{edges}, $E$.  An
\emph{edge} is a 2-element subset of $N$ representing a \emph{connection}
between a pair of \emph{nodes}.
...
attributes (i.e. degree distribution).
...
%% I'm really not sure how this works. Please Marc step in and make this
